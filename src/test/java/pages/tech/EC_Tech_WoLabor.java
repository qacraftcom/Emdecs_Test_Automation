...
public class EC_Tech_WoLabor extends TestDriverActions {
    ...
    @FindBy(xpath = "(//a[text()='Unit History'])[1]")
    public WebElement label_UnitHistory;

    @FindBy(xpath = "(//div[contains(@id,':rSV:0:phAvailableService')]//following::table[4]//td//a)[1]")
    public WebElement label_standardRepairTimes;

    @FindBy(xpath = "//input[contains(@id,':searchServiceId:dc_it1::content')]")
    public WebElement label_SearchTextArea;

    @FindBy(xpath = "//div[contains(@id,':rSV:2:pbServices')]//table//td//a")
    public WebElement label_TopUsedServices;
    ...
    @FindBy(xpath = "//h1[contains(.,'Move technician time to')]//parent::div//following::span[text ()='Select'] [1]")
    ...
    @FindBy(xpath = "(//img[contains(@id,':ciWoactStartId::icon')])[1]")
    public WebElement label_clock;
...
//    List<WebElement> crossIcon_All ;
   ...
   @FindBy(xpath = "//a[contains(@id,'clPopupWoact')]/following::span[text()='Accessories Group']")
    ...
    @FindBy(xpath = "//a[contains(@id,'clPopupWoact')]/following::span[text()='Aerodynamic Devices']")
    List<WebElement> aerodynamic1;
    @FindBy(xpath = "(//a[contains(@id,'ciDWoAct1')])[2]")
    List<WebElement> crossIcon_All;

    @FindBy(xpath = "(//a[contains(@id,'ciDWoAct1')])[2]")
    public  WebElement label_Close;
    /**
     * Enter TechBadge
     */
...
// WaitActions.getWaits().WaitUntilWebElementIsVisible(clockIcon.get(0));
    ...
    public void clickOnSelectButton2() throws InterruptedException {
        ...
        WaitActions.getWaits().waitForElementToBeRefreshedAndClickable(btn_select1);
        WebElementActions.getActions().clickUsingJS(btn_select1);
       // Thread.sleep(3000);
        WaitActions.getWaits().loadingWait(loder);
        TestListener.saveScreenshotPNG(driver);
    }
