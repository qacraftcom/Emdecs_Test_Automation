...
public class NonRepairBills extends TestDriverActions {
    ...
    @FindBy(xpath = "//input[@value='These are labor notes']")
    ...
    public void verifyRequiredSymbol() throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(mendatorysymbol_invocedate);
    ...
    public void verifyInvoiceDate () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(lebel_invoiceDate);
    ...
    public void verifyTodayDate () throws InterruptedException {
        ...
        //   WaitActions.getWaits().WaitUntilWebElementIsVisible(todays_Date);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(lebel_Customertext);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(lebel_CustomerFedExground);
    ...
    public void verifyStarBillTo () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(mendatorystar_Billto);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_BillTo);
    ...
    public void verifyBillToDropdownElement  () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(dropdown_BillTo);
    ...
    public void verifyDescriptionContentElement () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(input_Decriptioncontent);
    ...
    public void  verifyNotesText () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_Note);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(textarea_notesContent);
    ...
    public void verifySubTotalText () throws InterruptedException {
     ...
     //  WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_SubTotal);
    ...
    public void  verifyZeroPointZeroZeroSubTotalValue () throws InterruptedException {
       ...
       // WaitActions.getWaits().WaitUntilWebElementIsVisible(input_subTotalZero);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(label_Taxes);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(input_TaxesZero);
    ...
    public void verifyTotalValueZeroPointZeroZero () throws InterruptedException {
      ...
      //  WaitActions.getWaits().WaitUntilWebElementIsVisible(input_Tatalzero);
    ...
    public  void verifyStandard () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(input_USD);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(verify_Icon);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(label_Seq);
    ...
    public void verifyAccountText () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(label_Account);
    ...
    public void verifyDescriptionNotesText () throws InterruptedException {
      ...
      //  WaitActions.getWaits().WaitUntilWebElementIsVisible(label_DescriptionNotes);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_category);
   ...
   //     WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_Quantity);
    ...
    public void verifyUnitCharge() throws InterruptedException {
      ...
      //  WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_UnitCharge);
    ...
    public void verifyAmountText () throws InterruptedException {
      ...
      //  WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_Amount);
    ...
    public void verifyTaxOvrText () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(lebal_TaxOvr);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(img_crosssymbol);
    ...
    public void verifyAccountPane( ) throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(label_RevenueAccounts);
    ...
    public void verifySearchText ( ) throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(lebel_Search);
    ...
    public void verifySearchColumn () throws InterruptedException {
     ...
     //   WaitActions.getWaits().WaitUntilWebElementIsVisible(input_SearchCoulum);
    ...
    public void verifySearchIcon() throws InterruptedException {
       ...
       // WaitActions.getWaits().WaitUntilWebElementIsVisible(verify_Searchicon);
    ...
    //    WaitActions.getWaits().WaitUntilWebElementIsVisible(label_Submit);
    ...
    //    WaitActions.getWaits().waitForElementTobeClickable(dropdown_SelectBillTo);
    ...
    //    WaitActions.getWaits().waitForElementTobeClickable(textarea_typeNotesContent);
    ...
    public void selectFedExLabel () throws InterruptedException {
      ...
      //  WaitActions.getWaits().waitForElementTobeClickable(fedEx_Dropdown);
    ...
    public void clickSubmitButton () throws InterruptedException {
      ...
      //  WaitActions.getWaits().waitForElementTobeClickable(label_Submit);
    ...
    public void typeDescriptionNotes () throws InterruptedException {
     //   WaitActions.getWaits().waitForElementTobeClickable(input_DescriptionNotes);
    ...
    public void clickUserName  () throws InterruptedException {
       // WaitActions.getWaits().waitForElementTobeClickable(label_Username);
