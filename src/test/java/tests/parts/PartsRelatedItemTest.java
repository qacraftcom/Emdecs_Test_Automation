...
public class PartsRelatedItemTest extends TestDriverActions {
    ...
    public void gotoPartsMaster() throws FileNotFoundException, InterruptedException {
        loginPage.loginWithValidCredentials(prop.getProperty("service_two_username"), prop.getProperty("service_two_password") );
